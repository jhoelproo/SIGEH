...
REQUIRED_FILES = [
    ...
    ROOT / "admission_billing_consistency.py",
    ROOT / "admission_sheet_state.py",
    ROOT / "excel_artifact.py",
    ROOT / "billing_history_handoff.py",
    ROOT / "admission_specialty.py",
    ROOT / "excel_printing.py",
    ROOT / "turn_excel_delivery.py",
...
main_hidden_imports = sorted(
    set(
        [
            ...
            "PyPDF2",
            "admission_hybrid",
            "admission_billing_consistency",
            "admission_sheet_state",
            "excel_artifact",
            "billing_history_handoff",
            "admission_specialty",
            "excel_printing",
            "turn_excel_delivery",
